...
<body class="text-black font-poppins pt-10 pb-[50px]">
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col p-[70px_50px] gap-[30px]">
        ...
        <div class="grid grid-cols-4 gap-[30px]">
            <a href="{{route('front.category', 'sofware-development')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
            ...
            <a href="{{route('front.category', 'mobile-development')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Mobile Development</p>
            </a>
            ...
            <a href="{{route('front.category', 'network-development')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-3.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Network Development</p>
            </a>
        </div>
        <div class="grid grid-cols-3 gap-[30px]">
            <a href="{{route('front.category', 'data-science')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Data Science</p>
            </a>
            <a href="{{route('front.category', 'artificial-intelegence')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-4.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Artificial Intelegence</p>
            </a>
            <a href="{{route('front.category', 'ui-ux-development')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">UI UX Development</p>
            </a>
        </div>
    </section>
